...
export default function About() {
    return (
        ...
        <div className="container">
            ...
            <div className="border rounded p-4 wow fadeInUp" data-wow-delay="0.1s" style={{ visibility: "hidden", animationDelay: "0.1s", animationName: "none" }}>
                <div className="row g-4">
                    <div className="col-lg-4 wow fadeIn" data-wow-delay="0.1s" style={{ visibility: "hidden", animationDelay: "0.1s", animationName: "none" }}>
                        <div className="h-100">
                    ...
                    <div className="col-lg-4 wow fadeIn" data-wow-delay="0.3s" style={{ visibility: "hidden", animationDelay: "0.3s", animationName: "none"}}>
                        <div className="h-100">
                            <div className="d-flex">
                                <div className="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
                    ...
                    <div className="col-lg-4 wow fadeIn" data-wow-delay="0.5s" style={{ visibility: "hidden", animationDelay: "0.5s", animationName: "none" }}>
                        <div className="h-100">
                            <div className="d-flex">
                                <div className="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
